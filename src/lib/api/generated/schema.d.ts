...
export interface components {
    schemas: {
        ...
        /**
         * @description Infer a flat schema from a CSV header row and return flattened editor field rows.
         *                 csvText is the head slice of the upload; isCompleteFile says whether that slice is the whole file,
         *                 which is the only thing separating a truncated header from a complete header-only file.
         */
        InferJsonSchemaFromCsvTextParams: {
            csvText: string;
            isCompleteFile: boolean;
        };
        InferJsonSchemaFromCsvTextResult: {
            ok?: boolean;
            messages?: string[];
            errors?: string[];
            jsonSchemaString?: string;
        ...
        /** @description JSON-RPC request envelope for facade.JsonSchemaFacadeServices.infer#JsonSchemaFromCsvText */
        InferJsonSchemaFromCsvTextRequest: {
            /** @constant */
            jsonrpc: "2.0";
            id: string | number;
            /**
             ...
             * @enum {string}
             */
            method: "facade.JsonSchemaFacadeServices.infer#JsonSchemaFromCsvText";
            params?: components["schemas"]["InferJsonSchemaFromCsvTextParams"];
        };
        /** @description JSON-RPC success envelope for facade.JsonSchemaFacadeServices.infer#JsonSchemaFromCsvText. Check result.ok / result.errors for business failures. */
        InferJsonSchemaFromCsvTextResponse: {
            /** @constant */
            jsonrpc: "2.0";
            id?: string | number;
            result: components["schemas"]["InferJsonSchemaFromCsvTextResult"];
        };
