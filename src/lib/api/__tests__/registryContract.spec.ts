...
describe('registry contract — exported wrapper presence', () => {
  ...
  it('reconciliationFacade covers the core run lifecycle operations', () => {
    ...
    expect(typeof rf.createCsvRun).toBe('function')
    ...
    expect(typeof rf.pauseAutomation).toBe('function')
    expect(typeof rf.resumeAutomation).toBe('function')
...
describe('registry contract — known method string values', () => {
  ...
  it('reconciliationFacade wires the documented RECONCILIATION method strings', async () => {
    ...
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.create#CsvRun')
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.list#SavedRuns')
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.create#Mapping')
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.list#Mappings')
    ...
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.save#DashboardPinnedMappings')
    ...
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.delete#GeneratedOutput')
    ...
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.pause#Automation')
    expect(capturedMethods).toContain('facade.ReconciliationFacadeServices.resume#Automation')
