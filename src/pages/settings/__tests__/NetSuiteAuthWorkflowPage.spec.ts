...
describe('NetSuiteAuthWorkflowPage', () => {
  ...
  it('saves a shared config with no warning and no acknowledgment step', async () => {
    ...
    expect(wrapper.get('[data-testid="save-netsuite-auth"]').attributes('disabled')).toBeUndefined()
    ...
    expect(html.indexOf('Shared with')).toBeLessThan(html.indexOf('save-netsuite-auth'))
